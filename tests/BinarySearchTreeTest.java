...
public class BinarySearchTreeTest {
  ...
  public void testAdd() {
    ...
    assertEquals(tree.add('A'), true);

    // Add duplicate element
    assertEquals(tree.add('A'), false);

    // Add a second element which is not a duplicate
    assertEquals(tree.add('B'), true);
  }
  ...
  public void testRemove() {
    ...
    tree.add('A');
    assertEquals(tree.size(), 1);
    assertEquals(tree.remove('B'), false);
    assertEquals(tree.size(), 1);

    // Try removing an element which does exist
    tree.add('B');
    assertEquals(tree.size(), 2);
    assertEquals(tree.remove('B'), true);
    assertEquals(tree.size(), 1);
    assertEquals(tree.height(), 1);

    // Try removing the root
    assertEquals(tree.remove('A'), true);
    assertEquals(tree.size(), 0);
    assertEquals(tree.height(), 0);
  }
  ...
  public void testContains() {
    ...
    assertEquals(tree.contains('D'), false);

    // Try looking for an element which exists in the root
    assertEquals(tree.contains('B'), true);
    ...
    assertEquals(tree.contains('C'), true);
  }
  ...
  public void testPreOrderTraversal() {
    ...
    for (int i = 0; i < LOOPS; i++) {
      ...
      assertEquals(validateTreeTraversal(TreeTraversalOrder.PRE_ORDER, input), true);
    }
  }
  ...
  public void testInOrderTraversal() {
    ...
    for (int i = 0; i < LOOPS; i++) {
      List<Integer> input = genRandList(i);
      assertEquals(validateTreeTraversal(TreeTraversalOrder.IN_ORDER, input), true);
    }
  }
  ...
  public void testPostOrderTraversal() {
    ...
    for (int i = 0; i < LOOPS; i++) {
      List<Integer> input = genRandList(i);
      assertEquals(validateTreeTraversal(TreeTraversalOrder.POST_ORDER, input), true);
    }
  }
  ...
  public void testLevelOrderTraversal() {
    ...
    for (int i = 0; i < LOOPS; i++) {
      List<Integer> input = genRandList(i);
      assertEquals(validateTreeTraversal(TreeTraversalOrder.LEVEL_ORDER, input), true);
    }
  }
}